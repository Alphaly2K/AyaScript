...
export interface AyaScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `AyaScriptParser.sendStmt`.
	 * @param ctx the parse tree
	 */
	enterSendStmt?: (ctx: SendStmtContext) => void;
	/**
	 * Exit a parse tree produced by `AyaScriptParser.sendStmt`.
	 * @param ctx the parse tree
	 */
	exitSendStmt?: (ctx: SendStmtContext) => void;

	/**
	 * Enter a parse tree produced by `AyaScriptParser.readStmt`.
	 * @param ctx the parse tree
	 */
	enterReadStmt?: (ctx: ReadStmtContext) => void;
	/**
	 * Exit a parse tree produced by `AyaScriptParser.readStmt`.
	 * @param ctx the parse tree
	 */
